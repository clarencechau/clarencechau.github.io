...
const RangeSlider = factory.factory((_props, ref) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(Slider_context.SliderProvider, { value: { getStyles }, children: /* @__PURE__ */ jsxRuntime.jsxs(SliderRoot.SliderRoot, { ...others, size, ref, disabled, children: [
