...
const MenuTarget = React.forwardRef((props, ref) => {
  ...
  const onClick = createEventHandler.createEventHandler(children.props.onClick, () => {
  ...
  const onMouseLeave = createEventHandler.createEventHandler(children.props.onMouseLeave, () => {
