...
const Carousel = core.factory((_props, ref) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(Carousel_context.CarouselProvider, { value: { getStyles, orientation }, children: [
    /* @__PURE__ */ jsxRuntime.jsx(CarouselVariables.CarouselVariables, { ...props, selector: `.${responsiveClassName}` }),
    /* @__PURE__ */ jsxRuntime.jsxs(
      core.Box,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntime.jsx("div", { ...getStyles("viewport"), ref: emblaRefElement, children: /* @__PURE__ */ jsxRuntime.jsx("div", { ...getStyles("container"), "data-orientation": orientation, children }) }),
